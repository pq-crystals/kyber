...
#define PQCLEAN_NAMESPACE_CRYPTO_SECRETKEYBYTES  KYBER_SECRETKEYBYTES
#define PQCLEAN_NAMESPACE_CRYPTO_PUBLICKEYBYTES  KYBER_PUBLICKEYBYTES
#define PQCLEAN_NAMESPACE_CRYPTO_CIPHERTEXTBYTES KYBER_CIPHERTEXTBYTES
#define PQCLEAN_NAMESPACE_CRYPTO_BYTES           KYBER_SSBYTES
